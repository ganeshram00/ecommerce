...
const streamifier = require('streamifier'); // You can use streamifier to create streams from buffers
...
module.exports.updateProfile = async (req, res, next) => {
    try {
        ...
        // console.log("Avatar data:", req.files); // Debugging log for files
        ...
        if (req.files && req.files.avatar) {
            ...
            // Upload image to Cloudinary and get result
            const cloudinaryResult = await uploadCloudinary(req.files.avatar.data);

            // Add new avatar details to newUserData
            newUserData.avatar = {
